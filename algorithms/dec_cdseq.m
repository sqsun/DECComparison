% #############################
% ## CDSeq -- complete deconvolution method using RNA-seq data
% ## Modified Date£º?2019-6-7
% ############################
% ## Kang K., et al. 
% ## A novel computational complete deconvolution method using RNA-seq
% data. BioRxiv, https://doi.org/10.1101/496596.
% ## Details at https://github.com/kkang7/CDSeq (matlab)
